"""Shared constants for gathon code graph."""
...
# ---------------------------------------------------------------------------
MAX_IMPACT_NODES = int(os.environ.get("GATHON_MAX_IMPACT_NODES", "500"))
MAX_IMPACT_DEPTH = int(os.environ.get("GATHON_MAX_IMPACT_DEPTH", "2"))
MAX_BFS_DEPTH = int(os.environ.get("GATHON_MAX_BFS_DEPTH", "15"))
MAX_SEARCH_RESULTS = int(os.environ.get("GATHON_MAX_SEARCH_RESULTS", "20"))

# BFS engine: "sql" (SQLite recursive CTE) or "networkx" (Python-side BFS)
BFS_ENGINE = os.environ.get("GATHON_BFS_ENGINE", "sql")
